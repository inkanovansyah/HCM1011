...
class SubmitGoalSetting {
  ...
  factory SubmitGoalSetting.fromRawJson(String str) =>
      SubmitGoalSetting.fromJson(json.decode(str));

  String toRawJson() => json.encode(toJson());

  factory SubmitGoalSetting.fromJson(Map<String, dynamic> json) =>
      SubmitGoalSetting(
        status: json["status"],
        error: json["error"],
