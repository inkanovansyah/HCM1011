...
import 'package:hcm1011/presentasion/widgets/body/card_trining.dart';
...
class _DashboardState extends State<Dashboard> {
      ...
      child: Scaffold(
        ...
        body: ListView(
          children: [
            ...
            Container(
              color: grayColor, // Set the background color here
              height: 14.0,
  ...
  //         // Setelah data dihapus, perbarui list story
  ...
  //           // Hanya tampilkan data dengan is_delete == '0'
  ...
  //               itemCount:
  //                   filteredStoryList.length, // Berdasarkan data terfilter
  //               itemBuilder: (context, index) {
  //                 final story = filteredStoryList[index];
  //                 return _buildCarouselItem(context, story);
  //               },
  //             ),
  //           );
