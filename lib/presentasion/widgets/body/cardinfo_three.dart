...
class CardInfoThree extends StatefulWidget {
  const CardInfoThree({super.key});

  @override
  State<CardInfoThree> createState() => _CardInfoThreeState();
}

class _CardInfoThreeState extends State<CardInfoThree> {
  @override
  void initState() {
    Future.microtask(
